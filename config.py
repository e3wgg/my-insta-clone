...
# ── SMTP Email ────────────────────────────────────────────────
SMTP_HOST = "mail.e3wg.uk"       # غيّر لـ SMTP server الخاص بك
SMTP_PORT = 465                   # SSL port
SMTP_USER = "dewgram@e3wg.uk"    # البريد المرسل
SMTP_PASS = "changeme"           # ← ضع كلمة سر البريد هنا
SMTP_FROM = "Dewgram <dewgram@e3wg.uk>"
